...
# Dictionaries are for using one valie to look up another value (no order)
# A list is for a sequence of things that need to go in order
# Ordered Dictionaries are a data structure in Python for order
